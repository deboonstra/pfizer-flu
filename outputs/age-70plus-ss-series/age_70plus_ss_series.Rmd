...
subtitle: "using the 70+ age group cohort"
...
#### Summer seasonality
A diseases was classified to have summer seasonality if its global correlation with influenza was less than or equal to -0.60. There were 18 diseases that met this criteria.
```{r}
count <- 0
...
A diseases was classified to have no seasonality if its global correlation with influenza was less than 0.60 and greater than -0.60. There were diseases 214 that met this criteria.
```{r}
count <- 0
for (j in seq_len(nrow(corr_all))) {
