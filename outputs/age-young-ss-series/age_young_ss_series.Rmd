...
subtitle: "using the young age group (1-5) cohort"
...
#### Winter seasonality
A diseases was classified to have winter seasonality if its global correlation with influenza was greater than or equal to 0.60. There were 36 diseases that met this criteria.
```{r}
...
#### Summer seasonality
A diseases was classified to have summer seasonality if its global correlation with influenza was less than or equal to -0.60. There were 35 diseases that met this criteria.
```{r}
count <- 0
...
A diseases was classified to have no seasonality if its global correlation with influenza was less than 0.60 and greater than -0.60. There were diseases 129 that met this criteria.
```{r}
count <- 0
for (j in seq_len(nrow(corr_all))) {
