...
# combined ICD-9-CM and ICD-10-CM crossover data for the 18 to 64 age group.
...
if (!dir.exists("./outputs/age-18to64-ss-series/")) {
  dir.create("./outputs/age-18to64-ss-series/")
}

# Importing data ####
load("./data/final-incidence-series/age_incidence_4_15_24.RData")
...
saveRDS(
  object = icd_ts,
  file = "./outputs/age-18to64-ss-series/all_series.rds"
)
if (sum(convergence) > 0) {
  saveRDS(
    object = icd_ts_issue,
    file = "./outputs/age-18to64-ss-series/all_series_issue.rds"
  )
}
...
saveRDS(
  object = all_models,
  file = "./outputs/age-18to64-ss-series/all_models.rds"
)
if (sum(convergence) > 0) {
  saveRDS(
    object = all_models_issue,
    file = "./outputs/age-18to64-ss-series/all_models_issue.rds"
  )
}
