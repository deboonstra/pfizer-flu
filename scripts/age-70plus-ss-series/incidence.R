...
cause_mods <- readRDS(
  file = "./outputs/age-70plus-ss-series/causation_mods.rds"
)
load("./outputs/age-70plus-ss-series/clustering.RData")
...
saveRDS(
  object = change,
  file = "./outputs/age-70plus-ss-series/incidence_change.rds"
)