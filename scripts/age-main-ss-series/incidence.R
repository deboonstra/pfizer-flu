...
cause_mods <- readRDS(
  file = "./outputs/age-main-ss-series/causation_mods.rds"
)
load("./outputs/age-main-ss-series/clustering.RData")
...
saveRDS(
  object = change,
  file = "./outputs/age-main-ss-series/incidence_change.rds"
)