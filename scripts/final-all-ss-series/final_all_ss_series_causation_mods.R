...
all_extract <- readRDS(
  file = "./outputs/final-all-ss-series/final_all_extract.rds"
)
load("./outputs/final-all-ss-series/clustering.RData")
...
saveRDS(
  object = cause_mods,
  file = "./outputs/final-all-ss-series/causation_mods.rds"
)